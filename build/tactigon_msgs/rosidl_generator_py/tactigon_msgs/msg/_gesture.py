...
class Gesture(metaclass=Metaclass_Gesture):
    ...
    def __init__(self, **kwargs):
        ...
        self.displacement = kwargs.get('displacement', float())
    ...
    def displacement(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'displacement' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'displacement' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
