...
#include "tactigon_msgs/msg/detail/touch__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tactigon_msgs::msg::Touch & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tactigon_msgs::msg::Touch & ros_message)
{
  // Member: one_finger
  cdr >> ros_message.one_finger;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tactigon_msgs::msg::Touch;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tactigon_msgs::msg::Touch *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tactigon_msgs::msg::Touch *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Touch__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tactigon_msgs::msg::Touch *>(
...
static size_t _Touch__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Touch(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Touch__callbacks = {
  "tactigon_msgs::msg",
  "Touch",
...
static rosidl_message_type_support_t _Touch__handle = {
...
{
  return &tactigon_msgs::msg::typesupport_fastrtps_cpp::_Touch__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tactigon_msgs, msg, Touch)() {
  return &tactigon_msgs::msg::typesupport_fastrtps_cpp::_Touch__handle;
}
