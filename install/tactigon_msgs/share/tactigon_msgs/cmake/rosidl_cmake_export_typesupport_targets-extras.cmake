...
if(NOT _exported_typesupport_targets STREQUAL "")
  ...
  foreach(_tuple ${_exported_typesupport_targets})
    ...
    set(_target "tactigon_msgs::${_target}")
    if(NOT TARGET "${_target}")
      # the exported target must exist
      message(WARNING "Package 'tactigon_msgs' exports the typesupport target '${_target}' which doesn't exist")
    else()
      list(APPEND tactigon_msgs_TARGETS${_suffix} "${_target}")
    endif()
  endforeach()
endif()
